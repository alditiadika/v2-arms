...
declare namespace IAuthTypes {
  ...
  type IOnLogout = IGlobalTypes.IAction<void>
}
...
export const authTypes = {
  ...
  SET_DATA:'AUTH TYPES REDUCER SET DATA',
  SET_USER_EMPLOYEE_PROFILE:'AUTH TYPES REDUCER SET USER EMPLOYEE PROFILE',
  CLEAR_USER_PROFILE:'AUTH TYPES REDUCER CLEAR USER PROFILE',
  SET_USER_LOGIN:'AUTH TYPES REDUCER SET USER LOGIN',
  LOGOUT:'AUTH TYPES REDUCER LOGOUT',
}